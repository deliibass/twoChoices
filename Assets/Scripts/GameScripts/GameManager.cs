...
{
    [SerializeField]
    private GameObject puanSurePaneli, puaniKapYazisi, buyukSayiyiSec;

    [SerializeField]
    private Transform upRectangle, downRectangle;
    ...
    void SahneEkraniniGuncelle()
    {
        ...
        upRectangle.GetComponent<RectTransform>().DOLocalMoveX(0, 1f).SetEase(Ease.OutBack);
        downRectangle.GetComponent<RectTransform>().DOLocalMoveX(-0, 1f).SetEase(Ease.OutBack);
    }
